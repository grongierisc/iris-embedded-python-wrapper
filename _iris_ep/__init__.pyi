...
__all__ = [
    'ByRef', 'IRISList', 'IRISVector', 'Vector', 'check_status', 'cls', 'connect', 'createConnection', 'createIRIS', 'dbapi', 'execute', 'gref', 'ipm', 'iris_ipm',
    'lock', 'os', 'ref', 'routine', 'runtime', 'sql', 'system',
    'make_ref', 'tcommit', 'tlevel', 'trollback', 'trollbackone', 'tstart', 'unlock', 'utils',
]
...
class ByRef:
    """
    Lightweight by-reference container used when iris.ref is unavailable.
    """
    value: Any
    type: Any
    def __init__(self, value: Any = ..., type: Any = ...) -> None: ...

def make_ref(value: Any = ...) -> Any: ...

class IRISList:
    """
    Python value wrapper for IRIS $LIST parameters and result values.
    """
    def __init__(self, values: Any = ..., *, locale: str = ..., is_unicode: bool = ..., compact_double: bool = ...) -> None: ...
    @classmethod
    ...
    def index(self, value: Any, start: int = ..., stop: Any = ...) -> int: ...
    def count(self, value: Any = ...) -> int: ...
    def copy(self) -> "IRISList": ...
    def to_list(self) -> List[Any]: ...
    def add(self, value: Any) -> "IRISList": ...
    def set(self, index: int, value: Any) -> "IRISList": ...
    def get(self, index: int) -> Any: ...
    def getBoolean(self, index: int) -> bool: ...
    def getBuffer(self) -> bytes: ...
    def getBytes(self, index: int) -> bytes: ...
    def getDecimal(self, index: int) -> Any: ...
    def getFloat(self, index: int) -> float: ...
    def getIRISList(self, index: int) -> "IRISList": ...
    def getInteger(self, index: int) -> int: ...
    def getString(self, index: int) -> str: ...
    def remove(self, index: int) -> "IRISList": ...
    def clear(self) -> "IRISList": ...
    def size(self) -> int: ...
    def equals(self, irislist2: Any) -> bool: ...
    def to_param(self) -> bytes: ...
    def to_native(self, native_cls: Any = ...) -> Any: ...

class IRISVector:
    """
    Python value wrapper for IRIS SQL VECTOR parameters and embedded vector operations.
    """
    dtype: str
    def __init__(self, values: Any, dtype: Any = ...) -> None: ...
    @classmethod
    def from_db(cls, value: Any, dtype: Any = ...) -> "IRISVector": ...
    @classmethod
    def from_string(cls, value: str, dtype: Any = ...) -> "IRISVector": ...
    def __iter__(self) -> Iterator[Any]: ...
    def __len__(self) -> int: ...
    def __getitem__(self, index: Any) -> Any: ...
